...
def evaluate(data_file, pred_file, na_prob_file, na_prob_thresh=1.0, out_image_dir=None):
    with tf.io.gfile.GFile(data_file) as f:
        dataset_json = json.load(f)
        dataset = dataset_json['data']
    with tf.io.gfile.GFile(pred_file) as f:
        preds = json.load(f)
    if na_prob_file:
        with tf.io.gfile.GFile(na_prob_file) as f:
